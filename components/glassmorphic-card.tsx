...
export function GlassmorphicCard({ children }: GlassmorphicCardProps) {
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
    >
      <div className="relative overflow-hidden rounded-xl bg-slate-900/50 backdrop-blur-sm border border-blue-400/15 p-6 transition-all duration-300 hover:border-blue-500/50">
